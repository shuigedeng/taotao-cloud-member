...
/** 会员收藏数据处理层 */
public interface GoodsCollectionMapper extends BaseSuperMapper<MemberGoodsCollectionPO, Long> {
    ...
    //        IPage<GoodsCollectionVO> page, @Param(Constants.WRAPPER) Wrapper<GoodsCollectionVO>
    // queryWrapper);
}
