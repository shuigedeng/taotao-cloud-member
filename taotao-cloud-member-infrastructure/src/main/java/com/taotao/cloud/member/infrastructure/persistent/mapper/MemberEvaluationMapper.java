...
/** 会员商品评价数据处理层 */
public interface MemberEvaluationMapper extends BaseSuperMapper<MemberEvaluationPO, Long> {
    ...
    IPage<MemberEvaluationPO> getMemberEvaluationList(
            IPage<MemberEvaluationPO> page,
            @Param(Constants.WRAPPER) Wrapper<MemberEvaluationPO> queryWrapper);
