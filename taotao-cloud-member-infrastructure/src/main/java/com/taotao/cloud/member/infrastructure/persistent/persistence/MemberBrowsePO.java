...
@org.springframework.data.relational.core.mapping.Table(name = MemberBrowsePO.TABLE_NAME)
public class MemberBrowsePO extends BasePO<MemberBrowsePO> {

    public static final String TABLE_NAME = "ttc_member_browse";
