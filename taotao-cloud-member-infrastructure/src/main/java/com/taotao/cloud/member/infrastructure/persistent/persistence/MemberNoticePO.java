...
@org.springframework.data.relational.core.mapping.Table(name = MemberNoticePO.TABLE_NAME)
public class MemberNoticePO extends BasePO<MemberNoticePO> {

    public static final String TABLE_NAME = "ttc_member_notice";
