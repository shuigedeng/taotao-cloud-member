...
import com.taotao.cloud.member.application.service.command.MemberAddressCommandService;
 ...
 */
@Service
public class MemberAddressQueryServiceImpl implements MemberAddressCommandService {
    //	@Override
