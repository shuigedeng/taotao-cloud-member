...
package com.taotao.cloud.member.application.acl.dto.evaluation.result;
...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "评价数量响应对象")
public class EvaluationNumberResult implements Serializable {
