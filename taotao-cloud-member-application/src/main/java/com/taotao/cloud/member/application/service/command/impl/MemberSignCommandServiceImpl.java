...
import com.taotao.cloud.member.application.service.command.MemberSignCommandService;
 ...
 */
@Service
public class MemberSignCommandServiceImpl implements MemberSignCommandService {
    @Override
    ...
    //		}
    //		// 赠送会员积分
    //		memberCommandService.updateMemberPoint(point, PointTypeEnum.INCREASE.name(), memberId,
    //			content);
    //	}
    //	catch (Exception e) {
