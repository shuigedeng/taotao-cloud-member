...
package com.taotao.cloud.member.application.service.command.impl;

import com.taotao.cloud.member.application.service.command.MemberReceiptCommandService;
 ...
 */
@Service
public class MemberReceiptCommandServiceImpl implements MemberReceiptCommandService {
    //
    // @Autowired
    ...
    //	// 校验发票抬头是否重复
    //	List<MemberReceiptPO> receipts = this.baseMapper.selectList(new
    // QueryWrapper<MemberReceiptPO>()
