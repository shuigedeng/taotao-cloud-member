...
echo "================================================"
echo "  taotao-cloud-member 安全扫描"
echo "================================================"

# 扫描配置
BASE_DIR="."
MODULES=("taotao-cloud-member-api" "taotao-cloud-member-application" "taotao-cloud-member-domain" "taotao-cloud-member-infrastructure" "taotao-cloud-member-interfaces")
HAS_WARNINGS=0
