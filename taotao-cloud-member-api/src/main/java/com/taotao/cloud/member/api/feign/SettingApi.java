...
import com.taotao.cloud.member.api.feign.fallback.SettingApiFallback;
import com.taotao.cloud.member.api.feign.response.setting.AlipayPaymentSettingApiResponse;
import com.taotao.cloud.member.api.feign.response.setting.BaseSettingApiResponse;
import com.taotao.cloud.member.api.feign.response.setting.ExperienceSettingApiResponse;
import com.taotao.cloud.member.api.feign.response.setting.GoodsSettingApiResponse;
import com.taotao.cloud.member.api.feign.response.setting.OrderSettingApiResponse;
import com.taotao.cloud.member.api.feign.response.setting.PointSettingApiResponse;
import com.taotao.cloud.member.api.feign.response.setting.QQConnectSettingApiResponse;
import com.taotao.cloud.member.api.feign.response.setting.SeckillSettingApiResponse;
import com.taotao.cloud.member.api.feign.response.setting.SettingApiResponse;
import com.taotao.cloud.member.api.feign.response.setting.WechatConnectSettingApiResponse;
import com.taotao.cloud.member.api.feign.response.setting.WechatPaymentSettingApiResponse;
